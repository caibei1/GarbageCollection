            ...
            <div class="col-md-7"
                ...
                <form id="myform" class="form-horizontal" style="margin-top: 5px;">
                    ...
                    <div class="col-sm-6">
                        ...
                        <button class="btn btn-primary btn-lg" type="button" width="100"  id="back" style="margin-right: 50px;">返回</button>

                        <button class="btn btn-primary btn-lg"  width="100"  type="button" id="submit" orderId="${order.id}">提交</button>
                    </div>
                    <div style="height: 45px; clear:both;"></div>
                </form>
            </div>
...
<script type="text/javascript">
    ...
    $("#submit").click(function () {
        var id = $("#submit").attr("orderId");
        if (confirm("确认提交？")){
            alert("提交");
            window.location.href="${pageContext.request.contextPath}/finishOrder?id="+id;
        }
    });
