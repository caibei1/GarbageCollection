...
<div class="navbar navbar-default" role="navigation"> 
	...
	<c:if test="${user==null }">
		...
		<div class="col-sm-6" style="height: 60px; padding: 25px;">
			...
			<div class="col-sm-4">
				<a href="${pageContext.request.contextPath }/index" style="font-size: 25px;"><span class="glyphicon glyphicon-user"  style="font-size: 25px;"></span> 首页</a>
			</div>
	    	<div class="col-sm-4">
	...
	<c:if test="${user!=null }">
		...
		<div class="col-sm-6" style="height: 60px; padding: 25px;">
			...
			<div class="col-sm-3">
				<a style="font-size: 29px; color: black;" href="${pageContext.request.contextPath }/index"> 首页</a>
			</div>

	    	<div class="col-sm-5">
	    		<a style="font-size: 29px; color: black;" href="${pageContext.request.contextPath }/order"> 我的订单</a>
	    	</div>
	    	<div class="col-sm-4">
